...
module.exports.onLoad = async() => {
    ...
    if (!existsSync(path)) await downloadFile("https://i.imgur.com/JnLNED9.jpeg", path);
}
...
async function makeImage({ one, two }) {
    ...
    batgiam_img.composite(circleOne.resize(15, 13), 0, 0).composite(circleTwo.resize(1500, 1500), 790, 750);
